...
snakemake <- Snakemake(
    ...
    params = list(10, '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', 'ce10', 0, "minqual" = 10, "rdata" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "inBam" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', "assembly" = 'ce10', "mincov" = 0),
    ...
    resources = list(),
    config = list("PATHIN" = '/home/bosberg/bs/pigx_sandbox/test_dataset/in/', "bam_methCall_args_minqual" = '10', "NICE" = '19', "bam_methCall_args_mincov" = '0', "NUMTHREADS" = '2', "trim_galore_args" = '', "INEXT" = '.fq.gz', "CHROM_INFO" = '/home/bosberg/bs/ref_genome/ce10/chromInfo.txt', "PROGS" = list("BISMARK" = 'bismark', "BISMARK2REPORT" = 'bismark2report', "BISMARK_GENOME_PREPARATION" = 'bismark_genome_preparation', "BISMARK_METHYLATION_EXTRACTOR" = 'bismark_methylation_extractor', "BOWTIE2" = 'bowtie2', "CUTADAPT" = 'cutadapt', "DEDUPLICATE_BISMARK" = 'deduplicate_bismark', "FASTQC" = 'fastqc', "SAMTOOLS" = 'samtools', "TRIMGALORE" = 'trim_galore'), "GENOME_VERSION" = 'ce10', "bismark_args" = ' -N 1 -L 2 ', "LOG" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "NON_DIR_FLAG" = '', "SAMPLES" = list("sampleA" = list("ReadType" = 'WGBS', "SampleID" = 'sampleA', "Treatment" = 'A', "fastq_ext" = c('fq.gz', 'fq.gz'), "fastq_name" = c('output2K_1', 'output2K_2'), "files" = c('output2K_1.fq.gz', 'output2K_2.fq.gz')), "sampleB" = list("ReadType" = 'WGBS', "SampleID" = 'sampleB', "Treatment" = 'B', "fastq_ext" = c('fq.gz'), "fastq_name" = c('output2K_1'), "files" = c('output2K_1.fq.gz'))), "fastqc_args" = '', "RCODE" = '2K_', "GENOMEPATH" = '/home/bosberg/bs/ref_genome/ce10/', "PATHOUT" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "GTOOLBOX" = '/home/bosberg/.guix-profile/bin/'),
    rule = 'bam_methCall'
)
######## Original script #########
