...
snakemake <- Snakemake(
    ...
    output = list('methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', "rdatafile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "callFile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', "report" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html'),
    params = list(0, 'ce10', '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', 10, '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "mincov" = 0, "inBam" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', "minqual" = 10, "assembly" = 'ce10', "rdata" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData'),
    ...
    resources = list(),
    config = list("bismark_args" = ' -N 1 -L 2 ', "NICE" = '19', "LOG" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "RCODE" = '2K_', "NON_DIR_FLAG" = '', "fastqc_args" = '', "bam_methCall_args_minqual" = '10', "INEXT" = '.fq.gz', "trim_galore_args" = '', "PATHOUT" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "GENOME_VERSION" = 'ce10', "bam_methCall_args_mincov" = '0', "SAMPLES" = list("sampleA" = list("ReadType" = 'WGBS', "SampleID" = 'sampleA', "Treatment" = 'A', "fastq_ext" = c('fq.gz', 'fq.gz'), "fastq_name" = c('output2K_1', 'output2K_2'), "files" = c('output2K_1.fq.gz', 'output2K_2.fq.gz')), "sampleB" = list("ReadType" = 'WGBS', "SampleID" = 'sampleB', "Treatment" = 'B', "fastq_ext" = c('fq.gz'), "fastq_name" = c('output2K_1'), "files" = c('output2K_1.fq.gz'))), "NUMTHREADS" = '2', "PATHIN" = '/home/bosberg/bs/pigx_sandbox/test_dataset/in/', "PROGS" = list("BISMARK" = 'bismark', "BISMARK2REPORT" = 'bismark2report', "BISMARK_GENOME_PREPARATION" = 'bismark_genome_preparation', "BISMARK_METHYLATION_EXTRACTOR" = 'bismark_methylation_extractor', "BOWTIE2" = 'bowtie2', "CUTADAPT" = 'cutadapt', "DEDUPLICATE_BISMARK" = 'deduplicate_bismark', "FASTQC" = 'fastqc', "SAMTOOLS" = 'samtools', "TRIMGALORE" = 'trim_galore'), "GENOMEPATH" = '/home/bosberg/bs/ref_genome/ce10/', "GTOOLBOX" = '/home/bosberg/.guix-profile/bin/', "CHROM_INFO" = '/home/bosberg/bs/ref_genome/ce10/chromInfo.txt'),
    rule = 'bam_methCall'
)
######## Original script #########
