...
snakemake <- Snakemake(
    ...
    output = list('methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "callFile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', "report" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', "rdatafile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData'),
    params = list(0, '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', 'ce10', 10, "mincov" = 0, "rdata" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "inBam" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', "assembly" = 'ce10', "minqual" = 10),
    ...
    resources = list(),
    config = list("PATHIN" = '/home/bosberg/bs/pigx_sandbox/test_dataset/in/', "INEXT" = '.fq.gz', "NICE" = '19', "GENOMEPATH" = '/home/bosberg/bs/ref_genome/ce10/', "CHROM_INFO" = '/home/bosberg/bs/ref_genome/ce10/chromInfo.txt', "bam_methCall_args_minqual" = '10', "SAMPLES" = list("sampleA" = list("ReadType" = 'WGBS', "SampleID" = 'sampleA', "Treatment" = 'A', "fastq_ext" = c('fq.gz', 'fq.gz'), "fastq_name" = c('output2K_1', 'output2K_2'), "files" = c('output2K_1.fq.gz', 'output2K_2.fq.gz')), "sampleB" = list("ReadType" = 'WGBS', "SampleID" = 'sampleB', "Treatment" = 'B', "fastq_ext" = c('fq.gz'), "fastq_name" = c('output2K_1'), "files" = c('output2K_1.fq.gz'))), "PATHOUT" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "bam_methCall_args_mincov" = '0', "NON_DIR_FLAG" = '', "NUMTHREADS" = '2', "RCODE" = '2K_', "GENOME_VERSION" = 'ce10', "LOG" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "trim_galore_args" = '', "GTOOLBOX" = '/home/bosberg/.guix-profile/bin/', "fastqc_args" = '', "bismark_args" = ' -N 1 -L 2 ', "PROGS" = list("BISMARK" = 'bismark', "BISMARK2REPORT" = 'bismark2report', "BISMARK_GENOME_PREPARATION" = 'bismark_genome_preparation', "BISMARK_METHYLATION_EXTRACTOR" = 'bismark_methylation_extractor', "BOWTIE2" = 'bowtie2', "CUTADAPT" = 'cutadapt', "DEDUPLICATE_BISMARK" = 'deduplicate_bismark', "FASTQC" = 'fastqc', "SAMTOOLS" = 'samtools', "TRIMGALORE" = 'trim_galore')),
    rule = 'bam_methCall'
)
######## Original script #########
