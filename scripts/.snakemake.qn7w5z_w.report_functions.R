...
snakemake <- Snakemake(
    ...
    output = list('methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', "report" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', "rdatafile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "callFile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt'),
    params = list('/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', 'ce10', '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', 0, 10, "inBam" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', "assembly" = 'ce10', "rdata" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "minqual" = 10, "mincov" = 0),
    ...
    resources = list(),
    config = list("bam_methCall_args_minqual" = '10', "GTOOLBOX" = '/home/bosberg/.guix-profile/bin/', "NON_DIR_FLAG" = '', "fastqc_args" = '', "bam_methCall_args_mincov" = '0', "RCODE" = '2K_', "PATHOUT" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "CHROM_INFO" = '/home/bosberg/bs/ref_genome/ce10/chromInfo.txt', "NUMTHREADS" = '2', "LOG" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "NICE" = '19', "GENOMEPATH" = '/home/bosberg/bs/ref_genome/ce10/', "GENOME_VERSION" = 'ce10', "PATHIN" = '/home/bosberg/bs/pigx_sandbox/test_dataset/in/', "bismark_args" = ' -N 1 -L 2 ', "trim_galore_args" = '', "INEXT" = '.fq.gz', "PROGS" = list("BISMARK" = 'bismark', "BISMARK2REPORT" = 'bismark2report', "BISMARK_GENOME_PREPARATION" = 'bismark_genome_preparation', "BISMARK_METHYLATION_EXTRACTOR" = 'bismark_methylation_extractor', "BOWTIE2" = 'bowtie2', "CUTADAPT" = 'cutadapt', "DEDUPLICATE_BISMARK" = 'deduplicate_bismark', "FASTQC" = 'fastqc', "SAMTOOLS" = 'samtools', "TRIMGALORE" = 'trim_galore'), "SAMPLES" = list("sampleA" = list("ReadType" = 'WGBS', "SampleID" = 'sampleA', "Treatment" = 'A', "fastq_ext" = c('fq.gz', 'fq.gz'), "fastq_name" = c('output2K_1', 'output2K_2'), "files" = c('output2K_1.fq.gz', 'output2K_2.fq.gz')), "sampleB" = list("ReadType" = 'WGBS', "SampleID" = 'sampleB', "Treatment" = 'B', "fastq_ext" = c('fq.gz'), "fastq_name" = c('output2K_1'), "files" = c('output2K_1.fq.gz')))),
    rule = 'bam_methCall'
)
######## Original script #########
