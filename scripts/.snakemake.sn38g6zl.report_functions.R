...
snakemake <- Snakemake(
    ...
    output = list('methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html', 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "callFile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_CpG.txt', "rdatafile" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "report" = 'methylation_calls/output2K_1_val_1_bt2.deduped.sorted_meth_calls.nb.html'),
    params = list(10, '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', 'ce10', 0, "minqual" = 10, "inBam" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/06_sorted/output2K_1_val_1_bt2.deduped.sorted.bam', "rdata" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/methylation_calls/output2K_1_val_1_bt2.deduped.sorted_methylRaw.RData', "assembly" = 'ce10', "mincov" = 0),
    ...
    resources = list(),
    config = list("trim_galore_args" = '', "bam_methCall_args_minqual" = '10', "bam_methCall_args_mincov" = '0', "CHROM_INFO" = '/home/bosberg/bs/ref_genome/ce10/chromInfo.txt', "PATHOUT" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "NON_DIR_FLAG" = '', "NICE" = '19', "PATHIN" = '/home/bosberg/bs/pigx_sandbox/test_dataset/in/', "INEXT" = '.fq.gz', "GENOME_VERSION" = 'ce10', "fastqc_args" = '', "LOG" = '/home/bosberg/bs/pigx_sandbox/test_dataset/out/', "GENOMEPATH" = '/home/bosberg/bs/ref_genome/ce10/', "PROGS" = list("BISMARK" = 'bismark', "BISMARK2REPORT" = 'bismark2report', "BISMARK_GENOME_PREPARATION" = 'bismark_genome_preparation', "BISMARK_METHYLATION_EXTRACTOR" = 'bismark_methylation_extractor', "BOWTIE2" = 'bowtie2', "CUTADAPT" = 'cutadapt', "DEDUPLICATE_BISMARK" = 'deduplicate_bismark', "FASTQC" = 'fastqc', "SAMTOOLS" = 'samtools', "TRIMGALORE" = 'trim_galore'), "NUMTHREADS" = '2', "SAMPLES" = list("sampleA" = list("ReadType" = 'WGBS', "SampleID" = 'sampleA', "Treatment" = 'A', "fastq_ext" = c('fq.gz', 'fq.gz'), "fastq_name" = c('output2K_1', 'output2K_2'), "files" = c('output2K_1.fq.gz', 'output2K_2.fq.gz')), "sampleB" = list("ReadType" = 'WGBS', "SampleID" = 'sampleB', "Treatment" = 'B', "fastq_ext" = c('fq.gz'), "fastq_name" = c('output2K_1'), "files" = c('output2K_1.fq.gz'))), "RCODE" = '2K_', "GTOOLBOX" = '/home/bosberg/.guix-profile/bin/', "bismark_args" = ' -N 1 -L 2 '),
    rule = 'bam_methCall'
)
######## Original script #########
