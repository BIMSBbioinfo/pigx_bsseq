...
#TODO: check if this genome assembly is available
# if not add length of chromosomes base on only methylDiff.obj objects
require(rtracklayer)  
available.genomes = levels(ucscGenomes()$db)  
  
if(assembly %in% available.genomes){
  ...
  plot( ideoDMC_hyper_hypo(methylDiff.obj_hyper, methylDiff.obj_hypo, chrom.length = seqlengths( myseqinfo.st ),
