...
# output_dir: "/Users/agosdsc/Development/Snakemake/pigx_bsseq/methseg_rule/"
# output_file: "sampleA.pe1_trimmed_bismark_bt2.deduplicated.sorted.bam_meth_segments.html"
date: "`r Sys.Date()`"
bibliography: reports.bib
params:
  rdata: "methylation_calls/sampleA.pe1_trimmed_bismark_bt2.deduplicated.sorted_methylRaw.RData"
  grdata: "segmentation/sampleA.pe1_trimmed_bismark_bt2.deduplicated.sorted_meth_segments_gr.RData"
  outBed:   "segmentation/sampleA.pe1_trimmed_bismark_bt2.deduplicated.sorted_meth_segments.bed"
---
...
```{r load and segment}
    ...
    print(methRaw)
    saveRDS(methRaw,"~/tmp/methRaw.rds")

    ## Segmentation
    res.gr = methSeg(as(methRaw, "GRanges"),diagnostic.plot=TRUE)
